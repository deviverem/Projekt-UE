...
Original file is located at
    https://colab.research.google.com/drive/1Hr8z15r2nu6YvOZiI-gMq_Og4hOa-C7t
...
#sns.pairplot(df_all[['life ladder', 'gdp per capita', 'healthy life expectancy at birth', 'schizophrenia', 'bipolar disorder', 'eating disorders', 'anxiety disorders', 'drug use disorders', 'depressive disorders', 'alcohol use disorders', 'female suicide rate', 'male suicide rate', 'deaths by self-harm rate (both sexes)', 'male depressive disorder (percent)', 'female depressive disorder (percent)']], height=2.2)
#plt.show()
